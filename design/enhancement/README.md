...
Update, 8 September: voice delivery below remains current. The medical/account rework supersedes the local-history and setup-shortcut journey described in this historical enhancement record. Current suite: 52 tests. See [medical-rework/README.md](../medical-rework/README.md) and [operations](../../docs/OPERATIONS.md).
