...
export type SavedSession = SessionSummary & { mode: 'camera'; setup: Setup };
...
const en = {
  practice:'Practice', history:'My sessions', eyebrow:'MOVEMENT, ON YOUR TERMS', hero:'Start with\nyour movement.', intro:'Choose your setup. Find your exercise. Let your own range guide the session.',
  ...
  demoWaiting:'Watch how coaching responds to the simulated movement.',
  progress:'Set progress', range:'Your movement range', adjustment:'Movement support', noHistory:'Your next session starts here.', noHistoryBody:'Completed camera sessions appear here, stored only on this device. Demo sessions are kept out of your progress.',
...
const ar: typeof en = {
  ...
  stageLabels:['الوضعية','مدى الحركة','المجموعة'], demo:'معاينة التدريب', live:'حركتك', demoNotice:'حركة محاكاة — هذه النتائج ليست نتائجك', demoGuide:'دليل للتمرين — لا يعكس حركتك',
  signals:'تتبّع الحركة المحاكى', signalNote:'بيانات حركة تشغّل العرض التجريبي', coaching:'مدرّبك', waiting:'تحرّك بإيقاع مريح لك.',
  demoWaiting:'شاهد كيف تتغيّر الملاحظات مع الحركة المحاكاة.',
  progress:'تقدّم المجموعة', range:'مدى حركتك', adjustment:'دعم الحركة', noHistory:'جلستك القادمة تبدأ هنا.', noHistoryBody:'تظهر هنا جلسات الكاميرا المكتملة، وتُحفظ على هذا الجهاز فقط. لا تُضاف العروض التجريبية إلى تقدّمك.',
