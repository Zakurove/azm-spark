...
const OUT = process.env.SHOT_DIR ?? new URL("../design/screenshots", import.meta.url).pathname;
...
await capture({ fullPage: true, path: `${OUT}/a5-home-ar.png` });
console.log("shot home-ar");

// 2) Home — English
await page.goto(`${BASE}/?lang=en`);
await page.waitForTimeout(800);
await capture({ fullPage: true, path: `${OUT}/a5-home-en.png` });
...
await capture({ fullPage: true, path: `${OUT}/a5-framing-ar.png` });
console.log("shot framing");

await page.waitForSelector(".banner.cal", { timeout: 20000 });
await page.waitForTimeout(1200);
await capture({ fullPage: true, path: `${OUT}/a5-calibrating-ar.png` });
...
await page.waitForTimeout(400);
await capture({ fullPage: true, path: `${OUT}/a5-summary-ar.png` });
...
await capture({ fullPage: true, path: `${OUT}/a5-training-en.png` });
